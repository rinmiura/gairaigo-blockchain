...
from .chain_manager import connect
from .eventloop import Loop
from .transactions import concur_pool
from ..sec.rsa import export_pair, encrypt_transaction
from ..sec.validator import verify_transactions
from ..config import get_client_url, get_cipher_length
...
class Blockchain:
    ...
    def __init__(self, host):
        ...
        self.client_url = get_client_url()
        self.cipher_length = get_cipher_length()
    ...
    def awake(self):
        if exists(PRIVATE_KEY_PATH) and exists(PUBLIC_KEY_PATH):
            ...
            _, public = export_pair(PRIVATE_KEY_PATH, PUBLIC_KEY_PATH)
