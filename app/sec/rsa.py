...
from ..config import get_cipher_length
...
def export_pair(private_key_file_path, public_key_file_path):
    private, public = get_pair()
...
def get_pair():
    ...
    key = RSA.generate(get_cipher_length(), random_generator)
